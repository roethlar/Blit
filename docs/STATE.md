...
- `INTERFACE_PLATFORM.md`: no open rulings (D-2026-08-17-1..-5); open is only the Active flip and per-slice gos. The old UI_REMOVAL `blit-app` question is absorbed: `blit-app` becomes the SDK. 1.0 UX gate stays CLOSED (D-2026-08-15-2).
