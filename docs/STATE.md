...
Last updated: 2026-07-22 (rel-4 formal review fixes 3/6 complete)
...
- **NEXT ACTION — RELEASE BLOCKERS ONLY:** use `docs/RELEASE_READINESS.md`.
  ...
  allocation, attribute convergence, and per-file ADS isolation are fixed;
  three corrections remain. No rig work is queued.
