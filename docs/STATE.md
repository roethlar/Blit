...
Last updated: 2026-07-22 (wire metadata/path helpers consolidated)
...
- **NEXT ACTION — RELEASE BLOCKERS ONLY:** use `docs/RELEASE_READINESS.md`.
  ...
  through `w7-3`; dirty build IDs are exact without documentation churn.
...
5. **PAUSED: design-review queue** (`REVIEW.md`; `w7-5` is the top open row;
