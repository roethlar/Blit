...
- `INTERFACE_PLATFORM.md` ruling R4 (`blit-gui` move-vs-delete), the last open one; R1/R2/R5/R3 ruled (D-2026-08-17-1..-4). The old UI_REMOVAL `blit-app` question is absorbed: `blit-app` becomes the SDK. 1.0 UX gate stays CLOSED (D-2026-08-15-2).
