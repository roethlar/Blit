...
Last updated: 2026-07-22 (rel-4 formal review fixes 2/6 complete)
...
- **NEXT ACTION — RELEASE BLOCKERS ONLY:** use `docs/RELEASE_READINESS.md`.
  ...
  allocation and attribute convergence are fixed, with four corrections
  remaining. No rig work is queued.
