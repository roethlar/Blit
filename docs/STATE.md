...
Last updated: 2026-07-22 (control-plane duplicate reconciled)
...
- **NEXT ACTION — RELEASE BLOCKERS ONLY:** use `docs/RELEASE_READINESS.md`.
  ...
  through `w8-2`; dirty build IDs are exact without documentation churn.
...
5. **PAUSED: design-review queue** (`REVIEW.md`; `w8-3` is the top open row;
