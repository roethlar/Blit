...
- `INTERFACE_PLATFORM.md` rulings R3–R5 (`blit-tui` delete-vs-move, `blit-gui` move-vs-delete, `blit-prometheus-bridge` delete-vs-keep); R1/R2 ruled (D-2026-08-17-1/-2). The old UI_REMOVAL `blit-app` question is absorbed: `blit-app` becomes the SDK. 1.0 UX gate stays CLOSED (D-2026-08-15-2).
