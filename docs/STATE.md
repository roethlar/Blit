...
Last updated: 2026-07-22 (filter-normalization record reconciled)
...
- **NEXT ACTION — RELEASE BLOCKERS ONLY:** use `docs/RELEASE_READINESS.md`.
  ...
  and stale `w7-2`; dirty build IDs are exact without documentation churn.
...
5. **PAUSED: design-review queue** (`REVIEW.md`; `w7-3` is the top open row;
