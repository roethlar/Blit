...
Last updated: 2026-07-22 (presenter formatting consolidated)
...
- **NEXT ACTION — RELEASE BLOCKERS ONLY:** use `docs/RELEASE_READINESS.md`.
  ...
  through `w7-5`; dirty build IDs are exact without documentation churn.
...
5. **PAUSED: design-review queue** (`REVIEW.md`; `w8-1` is the top open row;
