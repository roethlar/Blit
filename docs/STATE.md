...
- Perf plan rulings R1–R3 (`docs/plan/PERF_HISTORY_PLANNING.md`): retire predictor for settled-dial seeds? fleet exposure deferred? rig A/B as the closing bar? — owner.
