...
0. **`docs/plan/CONTRACT_VERSION_GATE.md` (Draft, ruled D-2026-08-18-2)** — protocol version replaces the same-build session gate; scan/UIs surface daemons' protocol versions. Awaiting Active flip + per-slice gos (cv-1 gate, cv-2 surfacing, cv-3 docs-at-next-release).
