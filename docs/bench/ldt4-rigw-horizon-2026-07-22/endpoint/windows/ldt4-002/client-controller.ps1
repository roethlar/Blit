...
$dir = 'D:/blit-test/ldt4-f13/sessions/ldt4-20260722T022350Z-7050a2997ac5/logs/ldt4-002'
$process = $null
$stdoutStream = $null
$stderrStream = $null
try {
  ...
  foreach ($argument in @('copy','10.1.10.54:9031:/ldt4/src_horizon','D:/blit-test/ldt4-f13/sessions/ldt4-20260722T022350Z-7050a2997ac5/active/horizon/','--yes')) { [void]$info.ArgumentList.Add($argument) }
  $info.Environment['BLIT_TRACE_SESSION_PHASES'] = '1'
  $info.Environment['BLIT_TRACE_RUN_ID'] = 'ldt4-002'
  ...
  $expectedCommand = Normalize-Ldt4CommandLine 'D:/blit-test/bins/406a7e5/blit.exe copy 10.1.10.54:9031:/ldt4/src_horizon D:/blit-test/ldt4-f13/sessions/ldt4-20260722T022350Z-7050a2997ac5/active/horizon/ --yes'
  ...
  $identity = "run_id=ldt4-002`npid=$($process.Id)`nparent_pid=$PID`nexecutable=$actualPath`ncommand=$actualCommand`ntrace_session_phases=1`ntrace_run_id=ldt4-002`n"
