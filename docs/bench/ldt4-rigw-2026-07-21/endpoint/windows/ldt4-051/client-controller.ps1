...
$dir = 'D:/blit-test/ldt4-sessions/ldt4-20260721T224319Z-96a4e3b03caf/logs/ldt4-051'
$process = $null
$stdoutStream = $null
$stderrStream = $null
try {
  ...
  foreach ($argument in @('copy','10.1.10.54:9031:/ldt4/src_small','D:/blit-test/ldt4-sessions/ldt4-20260721T224319Z-96a4e3b03caf/active/small/','--yes')) { [void]$info.ArgumentList.Add($argument) }
  $info.Environment['BLIT_TRACE_SESSION_PHASES'] = '1'
  $info.Environment['BLIT_TRACE_RUN_ID'] = 'ldt4-051'
  ...
  $expectedCommand = Normalize-Ldt4CommandLine 'D:/blit-test/bins/406a7e5/blit.exe copy 10.1.10.54:9031:/ldt4/src_small D:/blit-test/ldt4-sessions/ldt4-20260721T224319Z-96a4e3b03caf/active/small/ --yes'
  ...
  $identity = "run_id=ldt4-051`npid=$($process.Id)`nparent_pid=$PID`nexecutable=$actualPath`ncommand=$actualCommand`ntrace_session_phases=1`ntrace_run_id=ldt4-051`n"
