...
$dir = 'D:/blit-test/ldt4-sessions/ldt4-20260721T224319Z-96a4e3b03caf/logs/ldt4-059'
$process = $null
$stdoutStream = $null
$stderrStream = $null
try {
  ...
  $info.Environment['BLIT_TRACE_RUN_ID'] = 'ldt4-059'
  ...
  $identity = "run_id=ldt4-059`npid=$($process.Id)`nparent_pid=$PID`nexecutable=$actualPath`ncommand=$actualCommand`ntrace_session_phases=1`ntrace_run_id=ldt4-059`n"
