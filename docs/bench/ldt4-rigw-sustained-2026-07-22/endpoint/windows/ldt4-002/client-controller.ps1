...
$dir = 'D:/blit-test/ldt4-sessions/ldt4-20260722T001611Z-04e80082e12c/logs/ldt4-002'
$process = $null
$stdoutStream = $null
$stderrStream = $null
try {
  ...
  foreach ($argument in @('copy','10.1.10.54:9031:/ldt4/src_sustained','D:/blit-test/ldt4-sessions/ldt4-20260722T001611Z-04e80082e12c/active/sustained/','--yes')) { [void]$info.ArgumentList.Add($argument) }
  ...
  $expectedCommand = Normalize-Ldt4CommandLine 'D:/blit-test/bins/406a7e5/blit.exe copy 10.1.10.54:9031:/ldt4/src_sustained D:/blit-test/ldt4-sessions/ldt4-20260722T001611Z-04e80082e12c/active/sustained/ --yes'
