...
| w4-5-supports-cancellation-flip | Medium | Flip supports_cancellation for Push/PullSync (owner-authorized D-2026-07-04-3): CancelJob + TUI F2 work on attached transfers; policy-only after w4-3's race wiring; contract change exit 2→0, TUI Unsupported surface gone; rewrite the active_jobs.rs policy rustdoc; tests pin the new contract | `[ ]` | — | — |
