...
|---------------------|----------|-------------------------------------------------------------|--------|------------------------------|-----------|
| a0-remote-helpers   | Refactor | Phase 5 A.0 — pull-flow helpers (enumerate + delete-list)  | `[~]`  | `phase5/blit-app-extract`    | `086fa49` |
...
| Slice                                          | Status |
|------------------------------------------------|--------|
| transfers/remote — pull-flow helpers           | `[~]` (a0-remote-helpers round 2 pending) |
