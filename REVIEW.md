...
|---------------------|----------|-------------------------------------------------------------|--------|------------------------------|-----------|
| a0-remote-helpers   | Refactor | Phase 5 A.0 — pull-flow helpers (enumerate + delete-list)  | `[x]`  | `phase5/blit-app-extract`    | `2c9029e` |
...
| Slice                                          | Status |
|------------------------------------------------|--------|
| transfers/remote — pull-flow helpers           | `[x]` (a0-remote-helpers verified) |
