...
| `REVIEW.md` + `.review/` | Two-agent coder/reviewer loop: status index, findings, sentinels, verdicts | leave | - | Working system with committed audit trail. (2026-06-20: cross-machine path references made repo-relative; the portable SETUP playbook is being folded into the governance system rather than kept in-repo.) |
