...
- Windows ReFS (4 GiB): blit 0.590 s vs robocopy 0.165 s — logs/windows/bench_local_windows_4gb_clone_20251026T020337Z.log (clone fast path active; robocopy still ~3× faster).      
