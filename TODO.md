...
- [ ] Investigate edge-case filesystem mirror gaps (ReFS 4 GiB: blit 0.374 s vs robocopy 0.155 s per `logs/windows/bench_local_windows_4gb_20251025T235715Z.log`; ZFS 4 GiB: blit 0.879 s vs rsync 18.309 s per `logs/truenas/bench_local_zfs_20251026T004021Z.log`). Profile planner/IO behaviour (priority on ReFS), prototype same-volume block-clone support (`FSCTL_DUPLICATE_EXTENTS_TO_FILE`), and fold findings into planner tuning.
